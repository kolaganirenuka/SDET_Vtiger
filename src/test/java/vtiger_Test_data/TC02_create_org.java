...
public class TC02_create_org {
	...
	public static void main(String[] args) throws Throwable {
		...
		String orgname=WorkbookFactory.create(fis1).getSheet("sheet1").getRow(3).getCell(0).getStringCellValue();

		driver.findElement(By.xpath("//input[@name='accountname']")).sendKeys(orgname);
WebElement	sel=driver.findElement(By.xpath("//select[@name='industry']"));
Select sele=new Select(sel);
sele.selectByValue("Insurance");
WebElement dd=driver.findElement(By.xpath("//select[@name='rating']"));
Select seldd=new Select(dd);
seldd.selectByValue("Acquired");
WebElement typ=driver.findElement(By.xpath("//select[@name='accounttype']"));
Select selty=new Select(typ);
selty.selectByValue("Analyst");
